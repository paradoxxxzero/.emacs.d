(custom-set-variables
 ...
 '(hl-paren-colors (quote ("orange1" "yellow1" "greenyellow" "green1" "springgreen1" "cyan1" "slateblue1" "magenta1" "purple" "red1" "orange1" "yellow1" "greenyellow" "green1" "springgreen1" "cyan1" "slateblue1" "magenta1" "purple" "red1")))
 '(home-end-enable t)
 ...
 '(jedi:key-complete [134217888])
 '(jedi:key-goto-definition (kbd "C-c g"))
 '(jedi:key-related-names (kbd "C-c r"))
 '(jedi:key-show-doc (kbd "C-c d"))
 '(jedi:server-command (quote ("python" "/home/zero/.emacs.d/elisp/emacs-jedi/jediepcserver.py")))
 '(jedi:setup-keys t)
 ...
 '(version-control t)
 '(virtualenv-root "/home/zero/.envs/")
...
(custom-set-faces
 ...
 '(ac-candidate-mouse-face ((t (:background "black" :foreground "yellow"))))
 '(ac-completion-face ((t (:foreground "deep sky blue" :underline t))))
 ...
 '(git-gutter:modified ((t (:foreground "gray45" :weight bold))))
 ...
 '(popup-face ((t (:background "black" :foreground "dark violet"))))
 '(popup-summary-face ((t (:inherit popup-face :foreground "deep pink"))))
 '(popup-tip-face ((t (:background "black" :foreground "DarkOrchid2"))))
 ...
 '(tooltip ((t (:inherit variable-pitch :background "black" :foreground "purple"))))
