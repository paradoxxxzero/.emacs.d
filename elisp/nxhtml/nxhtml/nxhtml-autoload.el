...
order."
  ...
  (add-to-list 'auto-mode-alist '("\\.jinja\\'"    . jinja-nxhtml-mumamo-mode))
  (add-to-list 'auto-mode-alist '("\\.jinja2\\'"   . jinja-nxhtml-mumamo-mode))
  (add-to-list 'auto-mode-alist '("\\.html.jinja\\'"    . jinja-nxhtml-mumamo-mode))
  (add-to-list 'auto-mode-alist '("\\.html.jinja2\\'"   . jinja-nxhtml-mumamo-mode))
